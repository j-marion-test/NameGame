...
public class WebTest {
    ...
    @Test
    public void test_clicking_correct_photo_increases_correct_counter() {
        new HomePage(driver)
                .validateClickingCorrectPhotoIncreasesCorrectCounter();
    }

    @Test
    public void test_clicking_correct_photos_increases_streak_counter() {
        new HomePage(driver)
                .validateClickingCorrectPhotosIncreasesStreakCounter();
    }

    @Test
    public void test_clicking_through_ten_times_tracking_counter() {
        new HomePage(driver)
                .validateClickingThroughTenTimesTrackingCounter();
    }

    @Test
    public void test_names_and_photos_change_after_correct_answer() {
        new HomePage(driver)
                .validateNamesAndPhotosChangeAfterCorrectAnswer();
    }
